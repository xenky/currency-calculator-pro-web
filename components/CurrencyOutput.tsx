...
export const CurrencyOutput: React.FC<CurrencyOutputProps> = ({ currency, value, rateInfo, onSettingsClick, isInputCurrency }) => {
  ...
  return (
    <div className={`p-2 rounded-lg shadow transition-all duration-200 ${isInputCurrency ? 'bg-indigo-100 dark:bg-indigo-900 border-2 border-indigo-400 dark:border-indigo-600' : 'bg-white dark:bg-slate-700'}`}>
